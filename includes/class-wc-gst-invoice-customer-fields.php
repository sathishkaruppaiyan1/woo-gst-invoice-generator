...
class WC_GST_Invoice_Customer_Fields {
    ...
    public function __construct() {
        ...
        add_filter('woocommerce_checkout_fields', array($this, 'add_gst_checkout_fields'));
     ...
     */
    public function add_gst_checkout_fields($fields) {
        // Remove state code and GSTIN fields from checkout
        unset($fields['billing']['billing_state_code']);
        unset($fields['billing']['billing_gstin']);
    ...
    public function add_gst_billing_fields($fields) {
        ...
        $fields['billing_state_code'] = array(
    ...
    public function add_gst_fields_to_order_details($fields) {
        // Keep state code and GSTIN fields in order details
        $fields['billing_state_code'] = array(
            'label' => __('State Code', 'woo-gst-invoice'),
            'show' => true,
            'type' => 'text'
